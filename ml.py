...
if __name__ == '__main__':
    ...
    #assert 'W1' in features_set, 'W1 is a mandatory feature'
    assert features_set.issubset({'ALL', 'DIFF', 'EXCL', 'LEN', 'NEG', 'NGTNEG', 'NGTPOS', 'POS', 'W1', 'W2', 'W3', 'W4', 'W5'}), 'There is an invalid feature name'
